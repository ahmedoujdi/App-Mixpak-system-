...
import { Wrench, ShieldCheck, Factory, Boxes, LayoutDashboard } from "lucide-react";

const ICONS = { mecanico: Wrench, calidad: ShieldCheck, produccion: Factory, almacen: Boxes, supervisor: LayoutDashboard };
    ...
    <div style={{ minHeight: "100vh", background: COLORS.dark, display: "flex", alignItems: "center", justifyContent: "center", padding: 20, fontFamily: "'IBM Plex Sans', sans-serif" }}>
      <div style={{ background: COLORS.panel, width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ padding: 28 }}>
          <h1 style={{ fontFamily: "'Oswald', sans-serif", textTransform: "uppercase", fontSize: 18, margin: "0 0 6px" }}>
            Mixpak System
          </h1>
          <p style={{ color: COLORS.textMuted, fontSize: 13, margin: "0 0 20px" }}>
            {user.email} — Elige tu categoría para ver solo lo que te corresponde. Puedes cambiarla luego.
          </p>
