export const ROLES = [
  ...
  { value: "supervisor", label: "Supervisor (acceso a todo)", tabs: ["resumen", "mantenimiento", "materiales", "produccion", "calidad"] },
  { value: "admin", label: "Administrador (aprueba usuarios, ve todo)", tabs: ["resumen", "mantenimiento", "materiales", "produccion", "calidad", "aprobaciones"] },
];
